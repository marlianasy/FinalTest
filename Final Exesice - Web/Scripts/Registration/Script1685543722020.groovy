...
WebUI.setText(findTestObject('Object Repository/Register/input_nama toko_name'), 'Test Toko Final')

WebUI.setText(findTestObject('Object Repository/Register/input_email_email'), 'testtoko@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/input_password_password'), 'aeHFOx8jV/A=')
